...
class RouteItemConverter : DbItemConverter<RouteEntity> {
    ...
    override fun serializeToAttrValue(
        ...
        return mapOf(
            ...
            RouteEntityAttributes.BUS_IDS to if(obj.busIds != null) AttributeValue.Ss(obj.busIds) else AttributeValue.Null(true),
        )
    }
    ...
    override fun deserializeToObject(
        ...
        return RouteEntity(
            ...
            busIds = attrValues[RouteEntityAttributes.BUS_IDS]?.asSsOrNull(),
        )
    }
}
